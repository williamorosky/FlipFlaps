...
//functions
		...
		title->set_color(fl_rgb_color(255,255,255));
		...
		score->set_color(fl_rgb_color(255,255,255));
		
		Rectangle *rect = new Rectangle(Point{(win_width/2)-220, 55},440,210);
		rect->set_fill_color(fl_rgb_color(0,145,255));
